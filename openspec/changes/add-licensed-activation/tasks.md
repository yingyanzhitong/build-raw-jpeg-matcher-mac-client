...
## 10. 腾讯云 SCF 部署与激活版 1.0.1

- [x] 10.1 创建广州地域的 Node.js 18 Web 函数、公开函数 URL 和生产环境变量
- [x] 10.2 新增 SCF HTTP 适配器、Web Crypto 兼容处理、请求体转发和自动化测试
- [x] 10.3 部署 SCF ZIP，验证健康检查、后台入口、非法激活、签名租约撤销结果和存量 Blob 数据
- [x] 10.4 将客户端、发布前检查、分支不变量和文档统一切换到公开函数 URL
- [x] 10.5 升级激活版和许可证服务版本，更新简体中文变更日志与 SCF 部署包工作流
- [x] 10.6 提交并合并到 `licensed`，推送 `license-service-v1.2.0` 与 `licensed-v1.0.1`，核验 GitHub Actions 和 Gitee
