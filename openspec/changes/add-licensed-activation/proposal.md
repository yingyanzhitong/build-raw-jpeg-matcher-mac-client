...
- 新增受 Cloudflare Access 保护的管理后台，支持批量生成 token、导出、查询、撤销和人工换机重置。
...
- 服务端：新增 TypeScript Cloudflare Worker、D1 migration、Worker Secrets、Rate Limiting 和 Cloudflare Access。
