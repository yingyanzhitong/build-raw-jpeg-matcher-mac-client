...
- 新增使用管理员账号密码登录的管理后台，支持批量生成 token、导出、查询、撤销和人工换机重置；`https://licensed.xyyamsz.cn/` 直接作为控制台入口。
...
- `license-administration`: 覆盖 EdgeOne Blob 授权数据、管理员身份校验、token 批量生成、查询、撤销、重置和审计。
