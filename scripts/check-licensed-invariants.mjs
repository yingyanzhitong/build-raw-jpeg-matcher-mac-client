...
assert.equal(workerConfig.name, "raw-jpeg-matcher-license");
assert.equal(workerConfig.routes[0].pattern, "licensed.xyyamsz.cn");
assert.equal(workerConfig.vars.PRODUCT_ID, "raw-jpeg-matcher-licensed");
